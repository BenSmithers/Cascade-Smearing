...
tray.Add("Delete",'del_time',Keys=['OfflinePulsesTimeRange'])
...
tray.AddModule('I3Writer', 'writer',
        ...
        Streams=[ icetray.I3Frame.Stream('S'), icetray.I3Frame.DAQ, icetray.I3Frame.Physics ,  icetray.I3Frame.Stream('M'),  icetray.I3Frame.Stream('S') ],
        filename=outfile)
